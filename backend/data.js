  ...
  products: [
    {
      ...
      numReviews: 10,
      description:
        "One of the easiest houseplants to grow, red aglaonema is also one of the most stylish. A relatively new variety to the houseplant world, this stunner shows off dark green leaves elegantly flushed with bright red or pink. Its colorful foliage makes red aglaonema a perfect home-decor accent.",
    },
    {
    ...
    },
    {
      ...
      numReviews: 16,
      description:
        "An important part of feng shui, lucky bamboo plants are said to bring good luck and fortune, especially if the plants were given as gifts. It also helps that they have a well-earned reputation as nearly indestructible; these tough stalks can survive in vases of pure water or in containers of soil, and in a wide variety of light conditions. Even a poorly kept lucky bamboo plant will live for a long time before it finally succumbs.",
    },
    {
      name: "Coffee Plant",
    ...
    },
    {
      ...
      numReviews: 26,
      description:
        "The Fiddle Leaf Fig is easily recognizable and loved for its distinctive foliage. This tall, dramatic plant has very large, heavily veined, violin-shaped leaves that grow upright. Native to the tropical climate of Western Africa, the Fiddle Leaf Fig thrives in very warm, bright, and humid conditions.",
    },
    {
      name: "Ginseng Ficus",
      ...
      numReviews: 47,
      description:
        "Native to Malaysia, Taiwan and other Southeast and East Asian countries, the Ginseng Ficus is noted for its thick, pot-bellied trunk and substantial exposed roots, giving the tree a every exotic and tropical feel. It is an excellent choice for bonsai specimens.",
    },
    {
    ...
    },
    {
      ...
      numReviews: 55,
      description:
        "The peace lily is a tropical species that is a favorite flowering houseplant. A striking plant when used in mass display, the peace lily blooms in spring with long-lasting flower stalks that hover gracefully over the foliage. They filter more indoor pollutants than most other plants, so are great for bedrooms or other frequented rooms. Inside the tropical plant's pores, toxic gases like carbon monoxide and formaldehyde are broken down and neutralized. A well-grown peace lily may bloom twice a year, resulting in several months of flowers.",
    },
    {
    ...
    },
    {
      ...
      numReviews: 73,
      description:
        "The ponytail palm makes a surprisingly interesting desktop plant, considering that when grown outdoors it can be a full-size tree that towers over homes. Indoors, these novel little trees are often grown in shallow pots, with a tuft of strappy green leaves emerging from a bulbous stem that seems to erupt from the soil. Contrary to their name, ponytail palms aren't actually related to palms, but classified within the asparacus family.",
    },
    {
    ...
    },
    {
      ...
      numReviews: 27,
      description:
        "The arrowhead vine is a tropical climber in the aroid family. Many varieties have variegated leaves to one degree or another, and like many aroids, the plant's leaf structure changes as it matures, going from a simple arrow shape to a deeply lobed or divided mature leaf. Provide them with bright, filtered light, warm and humidity and you will have a lush and healthy plant. ",
    },
    {
      name: "ZZ Gem",
      ...
      numReviews: 23,
      description:
        "ZZ plants are notorious for being low-maintenance, easy-to-care-for houseplants that even gardeners with the blackest of thumbs can keep alive. All they need to thrive is adequate light, and a good watering every couple of weeks. Characterized by their shiny, oval-shaped deep green leaves, ZZ plants make excellent additions to any home or office. Also drought tolerant.",
    },
    {
      name: "Moth Orchid",
      ...
      numReviews: 100,
      description:
        "These are ideal orchids for beginners, since they tolerate clumsy repotting and watering efforts, and bloom on and off throughout the year. These orchids prefer diffused lighting conditions but are otherwise very easy to grow. There are about 75 recognized species within the genus and many dozens of readily available cultivars. They will thrive in indirect indoor lighting or a shady outdoor location.",
    },
  ],
};
